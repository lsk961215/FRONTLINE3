...
public class BoardDTO {
	private int boardSeq = -1; // ¼÷¼Ò¹øÈ£
	private int userSeq = -1; 
	private int regionSeq = -1;
	private int typeSeq = -1;
	private String boardTitle; // ¼÷¼ÒÀÌ¸§
	private String boardAddress; // ¼÷¼ÒÁÖ¼Ò
	private String boardOpen; // ¼÷¼Ò¿ÀÇÂ½Ã°£
	private String boardDetail;
	private String boardRegDate; // µî·Ï½Ã°£
