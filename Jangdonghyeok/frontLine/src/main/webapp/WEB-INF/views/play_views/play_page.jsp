...
%>
            <div class="div1 place"><h2 class="title"><%=PlayDB.getPlayList().get(pageNumber).getTitle()%></h2></div>
			<h4 class="address"><%=PlayDB.getPlayList().get(pageNumber).getAddress() %></h4>
			<h5><%=PlayDB.getPlayList().get(pageNumber).getTell() %></h5>
            <div class="best_food">

                <div class="food_item">
					<img src="<%=PlayDB.getPlayList().get(pageNumber).getImage()%>">
                </div>
            ...
            <div class="div2">
                ...
                <span class="div2 title"><%=PlayDB.getPlayList().get(pageNumber).getDetail()%></span>
                <span class="div2 img"><img
